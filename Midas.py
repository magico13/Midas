...
def SaveApp(btnID):
    ...
    with open(AppName+".py", "w") as f:
        ...
        writeline(f, "\t\tself.DrawBackground(screen, {})".format(bkColor))
        ...
        existingCallbacks = []
        for b in ScreenButtons:
            if b.CallbackTxt != "None" and b.CallbackTxt not in existingCallbacks:
                ...
                writeline(f, "")
                existingCallbacks.append(b.CallbackTxt)
